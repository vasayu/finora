  ...
  return (
    <section className="bg-black text-white py-20 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        {/* CTA Box */}
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-12 sm:p-16 text-center relative overflow-hidden">
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            ...
            {/* Subheading */}
            <p className="text-white/90 text-lg sm:text-xl mb-10 max-w-3xl mx-auto">
              Join the 2,500+ financial leaders trusting our AI-driven platform to revolutionize 
              their operations.
            </p>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button className="bg-white hover:bg-gray-100 text-orange-500 font-semibold px-8 py-4 rounded-lg transition-all transform hover:scale-105 flex items-center gap-2 shadow-lg">
                <Calendar className="w-5 h-5" />
                Get Started Now
              </button>
              <button className="bg-transparent border-2 border-white hover:bg-white hover:text-orange-500 text-white font-semibold px-8 py-4 rounded-lg transition-all flex items-center gap-2">
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800">
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              © 2024 Finora AI. All rights reserved.
            </p>
