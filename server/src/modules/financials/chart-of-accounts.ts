...
export interface BSLineItem {
    ...
    account: string;
    /** Which transaction categories map to this line item for EXPENSE transactions */
    expenseCategories: string[];
    /** Which transaction categories map to this line item for INCOME transactions */
 ...
 */
export const CHART_OF_ACCOUNTS: BSLineItem[] = [
    // ─── ASSETS ───────────────────────────────────────────────────────
    {
        section: 'ASSETS',
 ...
 */
export function classifyTransaction(category: string, txType: 'INCOME' | 'EXPENSE'): string {
 ...
 */
export function getAccountHierarchy(): { section: BSSection; subSection: BSSubSection; account: string }[] {
    return CHART_OF_ACCOUNTS.map(item => ({
